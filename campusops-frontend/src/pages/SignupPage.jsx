        ...
        <form onSubmit={onSubmit} className="workspace-form">
          ...
          <label>
            ...
            <div className="inline-field">
              ...
              <button className="secondary-button" type="button" disabled={Boolean(loading)} onClick={sendVerificationMail}>
                {loading === 'send' ? '발송 중...' : mailSent ? '인증 메일 재발송' : '인증 메일 발송'}
              </button>
            </div>
          </label>
          ...
          {mailSent ? (
            <div className="email-verify-hint">
              ...
              <span>메일함에서 CampusOps 인증 페이지를 열고 인증하기 버튼을 눌러 주세요.</span>
