  ...
  return (
    <div className="workspace-page">
      <section className="workspace-hero">
        <div className="workspace-hero__copy"><span className="workspace-label">REPORT ADMIN</span><h1>신고 관리</h1><p>접수된 시설 신고의 처리 상태를 변경하고 관리자 답변을 등록합니다.</p></div>
        <div className="workspace-hero__aside"><span>전체 신고</span><strong>{items.length}건</strong></div>
      </section>
      <section className="workspace-card">
        <div className="workspace-card__head"><div><h2>신고 목록</h2><p>상태 변경 시 사용자에게 알림이 생성됩니다.</p></div></div>
